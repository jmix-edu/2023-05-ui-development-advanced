...
public class ProgrammaticProjectEdit extends StandardEditor<Project> {
    ...
    private void initData() {
        ...
        projectDl = dataComponents.createInstanceLoader();
    ...
    private void initForm() {
        ...
        DateField<LocalDateTime> startDateField = uiComponents.create(DateField.TYPE_LOCALDATETIME);
        initField(startDateField, "startDate");
        form.add(startDateField);

        DateField<LocalDateTime> endDateField = uiComponents.create(DateField.TYPE_LOCALDATETIME);
